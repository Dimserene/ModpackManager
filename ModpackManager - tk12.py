...
class ModpackManagerApp:
    ...
    def create_widgets(self):
        ...
        self.install_lovely_button.grid(padx=10, pady=5, ipady=5, row=8, column=2, columnspan=1, sticky="WE")
        ...
        self.revert_button.grid(padx=10, pady=5, ipady=5, row=8, column=3, columnspan=1, sticky="WE")
        ...
        self.info = tk.Label(self.root, text="Build: 2024/08/18, Iteration: 11th, Version: Release 0.5.2", font=('Helvetica', 8))
    ...
    def open_revert_popup(self):
        ...
        self.old_version_label = tk.Label(popup, text="Enter version to time travel:")
        self.old_version_label.grid(column=0, row=0, columnspan= 2, pady=5)

        self.old_version_entry = tk.Entry(popup, width=50)
        self.old_version_entry.grid(column=0, row=1, columnspan= 2, pady=5, padx=5)
        self.old_version_entry.insert(0, self.old_version)
    ...
    def submit_version(self):
        ...
        self.old_version = self.old_version_entry.get()
    ...
    def revert_version(self):
        modpack_name = self.modpack_var.get()
        repo_path = os.path.join(os.getcwd(), modpack_name)
        old_version = self.old_version_entry.get()
