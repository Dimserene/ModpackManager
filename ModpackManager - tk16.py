...
############################################################
    ...
    def create_widgets(self):
        ...
        self.backup_button.setToolTip("Automatically")
        ...
        self.info = QLabel("Build: 2024/08/25, Iteration: 16th, Version: Release 1.2.1", self)
    ...
    def init_menubar(self):
        ...
        exit_action.triggered.connect(self.close_application)  # Connect the exit action to close the app
        file_menu.addAction(exit_action)

        # Create a "Help" menu with a Credits action
        ...
        self.layout().setMenuBar(menubar)  # Assuming the main layout is a QVBoxLayout or QHBoxLayout
    ...
    #     <b>Q: What is the purpose of this Modpack Manager?</b><br>
    #     A: The Modpack Manager helps you install, manage, and update modpacks for the Balatro game with ease. It also provides automated backups of your save files.<br><br>

    #     <b>Q: How do I start using the Modpack Manager?</b><br>
    #     A: Simply launch the application, select a modpack, and use the available buttons to download, install, or manage modpacks. You can also configure settings for automated backups.<br><br>

    #     <b>Q: How can I set up automatic backups?</b><br>
    #     A: Go to the settings menu and configure the interval for backups. You can also manage existing backups from the backup management window.<br><br>

    #     <b>Q: How do I restore a previous backup?</b><br>
    #     A: In the Auto Backup settings, select a backup from the dropdown and click 'Restore Backup'. This will overwrite your current save with the selected backup.<br><br>

    #     <b>Q: Can I use this manager with other games?</b><br>
    #     A: This version is specifically designed for Balatro, but similar managers may be available for other games or custom modpack solutions.<br><br>

    #     <h3>Contact Support</h3>
    #     If you need further assistance, feel free to reach out to us at <i>[Your Support Email]</i> or visit our <a href="https://discord.com/invite/balatro">official Discord server</a>.
    #     """
    ...
    #     <b>Problem:</b> The application isn't downloading the modpack.<br>
    #     <b>Solution:</b> Ensure you have a stable internet connection and check if the modpack repository URL is correct. If the problem persists, try deleting the existing modpack folder and re-downloading it.<br><br>

    #     <b>Problem:</b> My mods aren't being installed correctly.<br>
    #     <b>Solution:</b> Double-check the Mods folder path in the settings. Make sure the mods are compatible with your current version of Balatro.<br><br>

    #     <b>Problem:</b> The automatic backup isn't working.<br>
    #     <b>Solution:</b> Check that you have set a proper interval for backups and that the destination folder exists. Make sure the backup timer is running by checking the "Start" and "Stop" buttons in the Auto Backup popup.<br><br>

    #     <b>Problem:</b> I restored a backup, but now my game crashes on launch.<br>
    #     <b>Solution:</b> The backup might have been corrupted or incompatible with the current game version. Try restoring a different backup or manually reverting to the default save.<br><br>

    #     <b>Problem:</b> I accidentally deleted all my backups.<br>
    #     <b>Solution:</b> Unfortunately, deleted backups cannot be recovered through the application. It’s recommended to manually copy and store backups in a safe location if needed.<br><br>

    #     <b>Problem:</b> The application freezes or crashes when selecting a modpack.<br>
    #     <b>Solution:</b> Try restarting the application and ensuring you have the latest version. If the issue continues, reinstall the application or seek help from the Balatro game community.<br><br>

    #     <h3>Contact Support</h3>
    #     If you need further assistance, feel free to reach out to us at <i>[Your Support Email]</i> or visit our <a href="https://discord.com/invite/balatro">official Discord server</a>.
    #     """

    #     QMessageBox.information(self, "Troubleshooting", troubleshooting_text)

    def show_credits(self):
        """Function to display the credits"""
        credits_text = """
        <h2>Credits</h2>
        <p><b>Modpack Manager Application</b><br>
        By <b>Dimserene, ChatGPT, ChatGPT Python bot</b></p>

        <h3>Special Thanks:</h3>
        <ul>
            <li>The Balatro Game Community</li>
        </ul>
        """
