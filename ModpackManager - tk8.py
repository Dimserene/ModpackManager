...
class ModpackManagerApp:
    ...
    def get_default_game_path(self):
        # Determine the default path based on the platform
        if platform.system() == "Windows":
            return r"C:\Program Files (x86)\Steam\steamapps\common\Balatro\Balatro.exe"
        else:
            return os.path.expanduser("~/.steam/steam/steamapps/common/Balatro/Balatro.exe")
