import io, subprocess, math, os, random, re, shutil, requests, webbrowser, zipfile, stat, json, git, time, platform
...
DATE = "2025/01/13"
ITERATION = "27"
VERSION = Version("1.7.0")  # Current version of the Modpack Manager
