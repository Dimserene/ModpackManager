...
############################################################
    ...
    def popup_mod_selection(self, mod_list, dependencies):
        ...
        # Create a QSplitter to divide left (filters) and right (mods) panels
        ...
        # Right panel (Scrollable mod list)
        right_panel = QWidget()
        ...
        def filter_mods():
            ...
            for mod_row_container, mod, checkbox, star_label in mod_vars:
                mod_metadata = self.metadata.get(mod, {})
